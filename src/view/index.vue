...
<style lang="scss" scoped>
	...
	.top{width:100%;height:px2rem(105);background: #0896ec;position: fixed;top:0;color:white;padding: 0 px2rem(27);display: flex;align-items: center;}
	.top img:nth-of-type(1){width:px2rem(75);height:px2rem(75);}
	.top img:nth-of-type(2){width:px2rem(55);height:px2rem(55);}
	.main .nav{width:px2rem(534);background: red;height:px2rem(75);margin: 0 px2rem(20);line-height: px2rem(75);overflow: hidden;position:relative}
	.nav ul{}
