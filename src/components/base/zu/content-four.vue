<template>
	<div class="box-one">
				<div class="title">
					<h2>{{data.title.substr(0,26)+'...'}}</h2>
					
				</div>
				
				<div class="img">
					<video width="100%" height="100%" src="@/assets/img/zu/我的梦.mp4" controls="" style="object-fit: fill" :poster="data.img[0].img1">
					</video>
				</div>
				<div class="news">
...
@import '../../../assets/css/pxrem.scss';
	...
	.box-one .img{width:100%;display: flex;justify-content: space-between;margin-top: px2rem(10);height:px2rem(500);position:relative}
